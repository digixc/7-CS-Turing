...
#+AUTHOR: Marc Scott, Stephen Brown,Xiaohui Ellis
...
- [[https://www.python.org/ftp/python/3.7.3/python-3.7.3-macosx10.6.pkg][Python 3.7.3 for Mac]]
- [[https://www.python.org/ftp/python/3.7.3/python-3.7.3-amd64-webinstall.exe][Python 3.7.3 for Windows]]
